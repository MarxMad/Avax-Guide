# Imágenes Semana 2 — Builders Hub

Las guías de la Semana 2 dejan espacio para imágenes de referencia del **Avalanche Builders Hub** y documentación oficial.
...
1. Descarga o captura la imagen desde el Builders Hub (o docs.avax.network).
2. Guárdala en esta carpeta (`semana-2/assets/`) con el nombre indicado en cada guía.
3. En los `.md` descomenta la línea `<!-- ![Título](./assets/nombre.png) -->` para mostrar la imagen.

---

## Nombres sugeridos (opcionales)
